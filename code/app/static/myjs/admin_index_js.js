...
function change(contracts) {
    ...
    console.log(contracts.conContent);
...
function onContractSelectChange(value) {
    ...
    ajaxGet("/exam/choose_contract", {'value': value}, change);
...
function selectChange(value) {
    let ele = document.getElementById("tableContentId");
    console.log(value);
    console.log(contentDict[value]);

    ele.value = contentDict[value];
}
